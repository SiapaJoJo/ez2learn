...
<head>
    ...
    <title>Student Dashboard - Ez2Learn</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="container">
        <div class="welcome-section">
            ...
            <p>You are logged in as <span class="username"><?php echo htmlspecialchars($_SESSION['username']); ?></span> (Student)</p>
        </div>
        ...
        <div class="dashboard-grid">
            <div class="card">
                <h3>My Courses</h3>
                <p>View and access all your enrolled courses here.</p>
            </div>
            <div class="card">
                <h3>Upcoming Assignments</h3>
                <p>Check your pending assignments and deadlines.</p>
            </div>
        </div>
    </div>
