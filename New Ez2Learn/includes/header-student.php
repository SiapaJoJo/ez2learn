...
if (strpos($script_path, '/student/module-') !== false) {
    $base_path = '../';
...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title . ' - ' : ''; ?>Student - Ez2Learn</title>
        ...
        <div class="header-top">
            ...
            <div class="header-right">
                <ul class="nav-menu">
                    ...
                    <li><a href="<?php echo $base_path; ?>module-managelearning/index.php" class="<?php echo strpos($current_path, 'module-managelearning') !== false ? 'active' : ''; ?>">📚 My Courses</a></li>
                    ...
                    <li><a href="<?php echo $base_path; ?>module-usermanagement/index.php" class="<?php echo strpos($current_path, 'module-usermanagement') !== false ? 'active' : ''; ?>">👤 Profile</a></li>
                </ul>
