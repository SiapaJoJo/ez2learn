...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title . ' - ' : ''; ?>Admin - Ez2Learn</title>
        ...
        <div class="header-top">
            ...
            <div class="header-right">
                ...
                <ul class="nav-menu">
                    ...
                    <li><a href="<?php echo $base_path; ?>module-managelearning/index.php" class="<?php echo strpos($current_path, 'module-managelearning') !== false ? 'active' : ''; ?>">📚 Courses</a></li>
